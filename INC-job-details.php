...
if (isset($_POST["submit"])) {
    $incubatename = $_POST["incubatename"];
    $email = $_POST["email"];
    $incubatenumber = $_POST["incubatenumber"];
    $incubateCategory = $_POST["incubateCategory"];
    $incubatefile = $_FILES['incubatefile']['name'];
    $Target = "Uploads/incubates/".basename($_FILES['incubatefile']['name']);
    $incubatedesc = $_POST["incubatedesc"];

    // $incubatefile = $_POST["incubatefile"];


    if(empty($incubatename)||empty($email)||empty($incubatenumber)||empty($incubateCategory)||empty($incubatefile)||empty($incubatedesc)){
        $_SESSION["ErrorMessage"]= "All fields must be filled out";
        Redirect_to("INC-job-details.php?id={$SarchQueryParameter}");  
    }
    else{
        
        // Query to insert category in DB when everything is fine
        global $DBConnection;
        $sql = "INSERT INTO Incubates(incubatename,email,incubatenumber,incubateCategory,incubatefile,incubatedesc)";
        $sql .= "VALUES(:incubatename,:email,:incubatenumber,:incubateCategory,:incubatefile,:incubatedesc)";
        $stmt = $DBConnection->prepare($sql);
        $stmt->bindValue(':incubatename',$incubatename);
        $stmt->bindValue(':email',$email);
        $stmt->bindValue(':incubatenumber',$incubatenumber);
        $stmt->bindValue(':incubateCategory',$incubateCategory);
        $stmt->bindValue(':incubatefile',$incubatefile);
        $stmt->bindValue(':incubatedesc',$incubatedesc);
        $Execute=$stmt->execute();
        move_uploaded_file($_FILES["incubatefile"]["tmp_name"],$Target);
    ...
    <section class="Job-details">
        <div class="job_details_area">
            <?php
                global $DBConnection;
                $IdFromURL = $_GET["id"];
                $sql = "SELECT * From inccategory WHERE id= '$IdFromURL'";
                $stmt = $DBConnection->query($sql);  
                while ($DataRows = $stmt->fetch()) {
                    $Id = $DataRows["id"];
                    $INCCategoryTitle = $DataRows["title"];
                    $Titleshortform = $DataRows["shortform"];
                    $Admin = $DataRows["author"];
                    $DateTime = $DataRows["datetime"];
                    $INCEligible = $DataRows["eligibility"];
                    $INCSalary = $DataRows["salary"];
                    $JobLocation = $DataRows["joblocation"];
                    $Vacancy = $DataRows["vacancy"];
                    $JObNature = $DataRows ["Job"];
                    $INClastdate = $DataRows["lastdate"];
                    $INCexpreq = $DataRows["expreq"];
                    $INCjobdesc = $DataRows["jobdecs"];
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="single_jobs white-bg d-flex justify-content-between">
                                <div class="jobs_left d-flex align-items-center">
                                    ...
                                    <div class="jobs_conetent">
                                        <a href="#"><h4><?php echo htmlentities($INCCategoryTitle)?></h4></a>
                        ...
                        <div class="descript_wrap white-bg">
                            <div class="single_wrap">
                                ...
                                <p><?php echo htmlspecialchars_decode($INCjobdesc); ?></p>
                            </div>
                            <!-- <div class="single_wrap">
                  ...
                  echo SuccessMessage();
                  ?>
                            <form action="INC-job-details.php?id=<?php echo $SarchQueryParameter?>" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input_field">
                                            <input type="text" name="incubatename" placeholder="Your name">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input_field">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input_field">
                                            <input type="text" name="incubatenumber" placeholder="Your Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <!-- <div class="input_field">
                                        <input type="text" name="incubatenumber" placeholder="Your Number"> -->
                                            <select class="form-select" name="incubateCategory" aria-label="Default select example">
                                                <?php
                                                    global $DBConnection;
                                                    $IdFromURL = $_GET["id"];
                                                    $sql = "SELECT * From inccategory WHERE id= '$IdFromURL'";
                                                ...
                                                <option selected><?php echo $INCCategoryTitle?></option>
                                                <?php } ?>
                                            </select>
                                        <!-- </div>     -->
                                    </div>
                                    ...
                                    <div class="col-md-12 my-4">
                                        <div class="input-group">
                                            ...
                                            <input type="file" class="custom-file-input" name="incubatefile" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input_field">
                                        <textarea class="form-control" id="Post" name="incubatedesc" rows="4"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="job_sumary">
                            ...
                            <div class="job_content">
                                <ul>
                                    ...
                                    <li>Salary: <span><?php echo htmlentities($INCSalary)?></span></li>
                                    <li>Location: <span><?php echo htmlentities($JobLocation)?></span></li>
                                    <li>Job Nature: <span> <?php echo htmlentities($JObNature)?></span></li>
                                    <li>Experience Required: <span> <?php echo htmlentities($INCexpreq)?></span></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-about mt-40">
                            ...
                            <p>BIC of Quaid i Azam university  is a one of the most popular Incubation Center in Pakistan, where student emplement their Idea and use the skill of skill full students and transfer their k nowledge to the new incubate in a better way.</p>
                            <ul class="mt-20">
