                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li class="nav-item">
                                        <a  class="active" href="Aim.php">Aim</a>
<!--                                         <ul class="sub-menu">
                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Aim</li>
                            </ol>
                        </nav>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 my-4">
                    ...
                    <p class="my-3">BIC at QAU aims to facilitate new company formation by providing an entrepreneurial nurturing environment for young start-up and spin-out technology companies; alleviating their survival and growth, thus encouraging them to reach their full potential. We aspire to develop individual talent, skills and personality to give each business the best possible start, thus fostering entrepreneurship at a local and national level.</p>
                </div>
            </div>
        </div>
    </section>
