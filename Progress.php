        ...
        <div class="container">
           <div class="row">
               ...
               <?php
                        ...
                        //Query For Pagination is Active
                     elseif (isset($_GET["page"])) 
                            ...
                            $sql = "SELECT * FROM posts ORDER BY id LIMIT $ShowPostFrom,5";
                            $stmt = $DBConnection->query($sql);
                            }   
                            //Query when Category is active in URL Tab
                            elseif (isset($_GET["category"])) {
                                $Category = $_GET["category"];
                                $sql = "SELECT * FROM posts WHERE category='$Category' ORDER BY id";
                                $stmt=$DBConnection->query($sql);
                                }           
                    ...
                    <div class="singel-blog mt-30">
                       <div class="blog-thum">
                           <img src="admin/Uploads/<?php echo htmlentities($Image); ?>" alt="Blog">
                       </div>
                       <div class="blog-cont">
                           <a href="Progress-single.php?id=<?php echo $Id; ?>"><h3><?php echo htmlentities($PostTitle); ?></h3></a>
                           <ul>
                           ...
                           <p>                            
                            <?php 
                                ...
                                if (strlen($PostDescription)>230) {
                                $PostDescription = substr($PostDescription,0,230).'........';
                                } 
                                echo strip_tags($PostDescription);
                   ...
                   <!-- <div class="singel-blog mt-30">
                       <div class="blog-thum">
                           <img src="images/news/1st.jpg" alt="Blog">
                       </div>
                       <div class="blog-cont">
                           <a href="Progress-single.php"><h3>Forth position out of 10 in IOBM and win 0.5 million PKR.</h3></a>
                           <ul>
                               <li><a href="#"><i class="fa fa-calendar"></i>1st June 2022</a></li>
                               <li><a href="#"><i class="fa fa-user"></i>Ms ShahTaj</a></li>
                               <li><a href="#"><i class="fa fa-tags"></i>Competition</a></li>
                           </ul>
                   ...
                   <!-- <div class="singel-blog mt-30">
                       <div class="blog-thum">
                           <img src="images/news/3.jpeg" alt="Blog">
                       </div>
                       <div class="blog-cont">
                           <a href="Progress-single.php"><h3>1st Position out of 90 and win 0.1 millions PKR</h3></a>
                           <ul>
                               <li><a href="#"><i class="fa fa-calendar"></i>10 May 2022</a></li>
                               <li><a href="#"><i class="fa fa-user"></i>Ms ShahTaj</a></li>
                               <li><a href="#"><i class="fa fa-tags"></i>Competition</a></li>
                           </ul>
                           <p>Lorem ipsum gravida nibh vel velit auctor aliquetn sollicitudirem quibibendum auci elit cons equat ipsutis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus .</p>
                   ...
                   <nav class="courses-pagination mt-50">
                        <ul class="pagination justify-content-lg-end justify-content-center">
                            ...
                            ?>                                                          
                            <li class="page-item">
                                <a href="Progress.php?page=<?php echo $Page-1?>" aria-label="Previous">
                            ...
                            <li class="page-item"><a class="active" href="Progress.php?page=<?php echo $i?>"><?php echo $i?></a></li>
                            <?php 
                                }
                                else{
                            ?>
                             <li class="page-item"><a href="Progress.php?page=<?php echo $i?>"><?php echo $i?></a></li>
                             <?php } ?>
                            <?php } }  ?>
                            <!-- <li class="page-item"><a href="Progress.php?page=2">2</a></li>
                            ...
                            ?>                           
                            <li class="page-item">
                                <a href="Progress.php?page=<?php echo $Page+1?>" aria-label="Next">
