...
<!--                                         <ul class="sub-menu">
                         <li><a href="courses.php">Courses</a></li>
                                <li><a href="courses-singel.php">Course Singel</a></li>
                                    ...
                                    <li class="nav-item">
                                <a class="active" href="objective.php">Objectives</a>
<!--                                         <ul class="sub-menu">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 my-4">
                    ...
                    <ul class="my-3">
                        <li style="list-style: disc;">To foster an entrepreneurial culture, by providing the students, alumni, and faculty, opportunities to transform their business ideas to reality. These facilities are also open to the general public, provided they can either leverage QAU's knowledge base or contribute to QAU's knowledge base.</li>
                        <li style="list-style: disc;">To facilitate the availability of QAU resources to the incubatees in a mutually beneficial way.</li>
                        <li style="list-style: disc;">To provide a conducive working environment to the incubatees to nurture their innovative ideas. </li>                    
                        <li style="list-style: disc;">To liaise with private and public sector funding sources, government agencies, industrial associations, chambers of commerce and industries to provide facilitation and networking for incubate companies. </li>                                                    
                    </ul>
                </div>
            </div>
        </div>
