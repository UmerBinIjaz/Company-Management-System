                            ...
                            <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                                <div class="job-left my-4 d-md-flex align-items-center flex-wrap">
                                    ...
                                    <div class="job-content">
                                        <a href="INC-job-details.php?id=<?php echo htmlentities($Id)?>"><h5 class="text-center text-md-left"><?php echo htmlentities($INCCategoryTitle)?></h5></a>
                                ...
                                <div class="job-right my-4 flex-shrink-0">
                                    <a href="INC-job-details.php?id=<?php echo htmlentities($Id)?>" class="btn d-block w-100 d-sm-inline-block btn-light">Apply now</a>
                                </div>
                            </div>
