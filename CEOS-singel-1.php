                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">CEO's</li>
                            </ol>
                        </nav>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="teachers-left mt-50">
                        <div class="hero">
                            <img src="images/CEOS/shahahad.jpeg" alt="Teachers">
                        </div>
                        <div class="name">
                            <h6>Shah Ahad</h6>
                            <span>CEO Founder <br>Digital Smart Solution </span>
                        </div>
                        <div class="social">
                            <ul>
