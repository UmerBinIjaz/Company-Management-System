        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">All Internees </h4>
                  <?php echo ErrorMessage();
                  echo SuccessMessage();
                  ?>
                  <div class="my-4">
                  <a href="exportincubate.php"><span class="btn btn-info text-light"><i class="fas fa-trash"></i> Export</span></a>
                  </div>
                  <!-- <p class="card-description">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <?php 
                            echo htmlentities($Jobapplied); 
                            ?>
                          </td>
                          <td>
                            <?php
                            if (strlen($Interneedesc)>20) {
                                $Interneedesc = substr($Interneedesc,0,18).'...';
                                }
                                echo $Interneedesc; 
                            ?>
                          </td>
                          <td>
                            <a href="../Uploads/internees/<?php echo $Interneefile?>"><span class="btn btn-primary text-light"><i class="fas fa-download"></i>Download CV</span></a>
                          </td>
                          <td> 
                              <a href="Deleteinternee.php?id=<?php echo $InterneeId; ?>"><span class="btn btn-danger text-dark"><i class="fas fa-trash"></i> Delete</span></a>
                          </td>
                        </tr>
                      </tbody>
                      <?php } ?>
                  ...
                  <a href="export.php"><span class="btn btn-primary text-dark"><i class="fas fa-trash"></i> Export</span></a>
                  </div> -->
                </div>
              </div>
            </div>
