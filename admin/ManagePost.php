...
if (isset($_POST["submit"])) {
  ...
  $Target = "admin/Uploads/".basename($_FILES['Image']["name"]);
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <td><?php echo $Sr ?></td>
                          ...
                          <td>
                            <a href="EditPost.php?id=<?php echo $Id; ?>"><span class="btn btn-info text-dark" ><i class="fas fa-edit"></i> Edit</span></a>
                            <a href="DeletePost.php?id=<?php echo $Id; ?>"><span class="btn btn-danger text-dark"><i class="fas fa-trash"></i> Delete</span></a>
                          </td>
                          <td><a href="../Progress-single.php?id=<?php echo $Id; ?>" target="_blank"><span class="btn btn-primary text-light"><i class="fas fa-search"></i> Live Preview</span></a></td>
                        </tr>
