        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">All Incubates </h4>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <?php
                            if (strlen($Incubatedesc)>20) {
                                $Incubatedesc = substr($Incubatedesc,0,18).'...';
                                }
                                echo $Incubatedesc; 
                            ?>
                          </td>
                          <td>
                            <a href="../Uploads/incubates/<?php echo $Incubatefile?>"><span class="btn btn-primary text-light"><i class="fas fa-download"></i>Download CV</span></a>
                          </td>
                          <td> 
                              <a href="Deleteincubate.php?id=<?php echo $IncubateId; ?>"><span class="btn btn-danger text-dark"><i class="fas fa-trash"></i> Delete</span></a>
                          </td>
                        </tr>
                      </tbody>
                      <?php } ?>
