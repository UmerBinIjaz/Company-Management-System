 ...
 $Admin = $_SESSION["UserName"];
  ...
  $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    ...
    elseif(strlen($PostDescription)<20) {
      $_SESSION["ErrorMessage"]= "Post description should be greater than 20 characters";
      Redirect_to("AddPost.php");      
    }    
    elseif(strlen($PostDescription)>9999) {
      ...
      if ($Execute) {
        $_SESSION["SuccessMessage"]= "Post with id : " .$DBConnection->lastInsertId()." added Succesfully";
        Redirect_to("AddPost.php");          
      }
