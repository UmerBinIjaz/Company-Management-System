            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="AddSubcategory.php" method="post">
                    <div class="form-group">
                      <label for="title">Category Name</label>
                      <input type="text" class="form-control" name="SubCategoryTitle" id="title" placeholder="CategoryTitle">
                    </div>
                    <div class="form-group">
