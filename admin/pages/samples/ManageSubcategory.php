...
if (isset($_POST["submit"])){
    ...
    if (empty($SubCategoryTitle)||empty($category)) {
        $_SESSION["ErrorMessage"]= "All fields must be filled out";
        Redirect_to("AddSubCategory.php");
        
      }
      elseif(strlen($SubCategoryTitle)<3) {
        $_SESSION["ErrorMessage"]= "Category title should be greater than 2 characters";
        Redirect_to("AddSubCategory.php");      
      }
      elseif(strlen($SubCategoryTitle)>49) {
        ...
        Redirect_to("AddSubCategory.php");      
            ...
            global $ConnectingDB;
            $sql = "INSERT INTO subcategory(SubCategoryTitle,category,datetime)";
            $sql .= "VALUES(:SubCategoryTitle,:category,:dateTime)";
            $stmt = $ConnectingDB->prepare($sql);
            $stmt->bindValue(':SubCategoryTitle',$SubCategoryTitle);
            $stmt->bindValue(':category',$category);
            // $stmt->bindValue(':adminName',$Admin);
            $stmt->bindValue('dateTime',$DateTime);
            $Execute=$stmt->execute();
            if ($Execute) {
                $_SESSION["SuccessMessage"]= "SubCategory with id : " .$ConnectingDB->lastInsertId()." added Succesfully";
                Redirect_to("AddSubCategory.php");          
              }
              else {
                    ...
                    <table class="table table-striped">
                      ...
                      <?php 
                        ...
                        while ($DataRows=$Execute->fetch()) {
                          $SubCategoryId = $DataRows["id"];
                          $SubCategoryDate = $DataRows["datetime"];
                          $SubCategoryName = $DataRows["SubCategoryTitle"];
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <?php echo htmlentities($SubCategoryDate);?>
                          </td>
                          <td>
                            <?php echo htmlentities($SubCategoryName);?>  
                          </td>    
                          <td>
                          ...
                          <td>
                          <a href="DeleteSubCategory.php?id=<?php echo $SubCategoryId ; ?>"><span class="btn btn-danger text-dark"><i class="fas fa-trash"></i> Delete</span></a>
                          </td>
                        </tr>
                        <!-- <tr>
                          <td class="py-1">
