...
<?php
  ...
  $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    ...
    elseif($Password != $ConfirmPassword) {
      $_SESSION["ErrorMessage"]= "Password and Confirm Password is not same";
      Redirect_to("AddUsers.php");      
    }
    elseif(CheckUserNameExistsOrNot($UserName)) {
      ...
      global $ConnectingDB;
      $sql = "INSERT INTO admin(datetime,username,Email,password,aname)";
      $sql .= "VALUES(:dateTime,:userName,:Email,:password,:aName)";
      ...
      if ($Execute) {
        ...
        // $to = "$Email";
        // $Subject = "Email Service & UK TECHNICA";
        // $from = "uk302268@gmial.com";
        // $headers = "From: $from\r\n";
        ...
        // <html>
        // <body>
        // <h3>$UserName ( Stay Home , Stay Safe )</h3>
        // <p>UK TECHNICA with Email Service is activiated to be used for blogging activities.</p>
        // <h3>For UK TECHNICA </h3>
        // <span style='font-family:Calibri;font-size:16px'>Login URL: </span>
        // <a href='http://localhost/Content%20Management%20System/AdminLogin.php'>Visit Our Website UK TECHNICA!</a>
        // <br>
        // <span style='font-family:Calibri;font-size:16px'>UserName: </span>$UserName
        // <br>
        // <span style='font-family:Calibri;font-size:16px'>Password: </span>$Password    
        // </body>
        // </html>
        // ";      
         
        //   if (mail($to,$Subject,$sendmessage,$headers)) {
        //     $_SESSION["SuccessMessage"]= "Username and Password has been send to that admin through email";
        //   }
        //   else{
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="../../pages/forms/ManagePost.php">Manage Posts</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  echo SuccessMessage();
                  ?>
                  <form class="forms-sample"  action="AddUsers.php" method="post">
                  <div class="form-group">
