              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php 
                    ...
                    echo SuccessMessage(); 
                  ?>
                  <form class="forms-sample" action="AddPost.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="title">Post Title</label>
                      <input type="text" name="PostTitle"  class="form-control" id="exampleInputName1" placeholder="Name">
                    </div>
                    <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="CategoryTitle">Choose Category</label>
                        ...
                        global $ConnectingDB; 
                          ...
                          $sql = "SELECT id,SubCategoryTitle,category	 From subcategory";
                          $stmt = $ConnectingDB->query($sql);
                          while ($DataRows = $stmt->fetch()) {
                            $Id = $DataRows["id"];
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="Post" name="PostDescription rows="4"></textarea>
                    </div>
