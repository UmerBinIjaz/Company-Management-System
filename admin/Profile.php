...
//   $abio = $_POST["abio"];
  ...
  // $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    ...
    if($Password != $ConfirmPassword)  {
      ...
      global $DBConnection;
        $sql = "UPDATE admin 
                SET aimage='$Image', Password='$Password' WHERE id='$AdminId'";     
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <br>
                  <form  class="forms-sample" action="Profile.php" method="post" enctype="multipart/form-data">
                    <span class="FieldInfo">Existing Image: </span>

                        <?php if (empty($ExistingImage)) {
                            
                        ?>
                        <img class="mt-3" src="images/faces/face28.jpg" height="70px" width="70px" alt="Profile image">
                        <?php }
                        else{
                        ?>
                        <img class="mt-3" src="Uploads/<?php echo $ExistingImage;?>" width="170px" height="70px">
                    <?php } ?>
                        <div class="form-group">
