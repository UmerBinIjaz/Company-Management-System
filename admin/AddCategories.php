...
<?php
  ...
  $DateTime=strftime("%B-%d-%Y %H:%M:%S",$CurrentTime);
    ...
    elseif(strlen($Category)>49) {
      ...
      if ($Execute) {
        $_SESSION["SuccessMessage"]= "Category with id : " .$DBConnection->lastInsertId()." added Succesfully";
        Redirect_to("AddCategories.php");          
      }
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="AddCategories.php" method="post">
                    <div class="form-group">
                      <label for="title">Category Name</label>
                      <input type="text" class="form-control" name="CategoryTitle" id="title" placeholder="CategoryTitle">
                    </div>
