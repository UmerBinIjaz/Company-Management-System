          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="DeletePost.php">Delete Post</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                  <form class="forms-sample" action="DeletePost.php?id=<?php echo $SarchQueryParameter; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <img class="mt-3" src="Uploads/<?php echo $ImageToBeDeleted;?>" width="170px" height="70px">
                      <br><br><br>
                    ...
                    <div class="form-group">
                      ...
                      <?php 
                        echo $PostDescriptionToBeDeleted;

                         ?>
                      </textarea>
                    </div>
                    <button type="submit" name="submit" class="btn btn-primary mr-2">Delete</button>
