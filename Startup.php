...
<!--                                         <ul class="sub-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="active" href="Startup.php">Start Up</a>
                                    </li>
                        <li class="nav-item">
    ...
    <!--====== START UP PAGE START ======-->
    <section class="Startup   pt-90 pb-120">
        <div>
            <div class="container">
                <div class="row patnar-slied">
                    <div class="col-lg-12">
                        <div class="singel-patnar text-center mt-40">
                            <img src="images/Companies/ITSCOUT.png" alt="Logo">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="singel-patnar text-center mt-40">
                    ...
                    <div class="col-lg-12">
                        <div class="singel-patnar text-center mt-40">
                            <img src="images/Companies/digital.png" alt="Logo">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="singel-patnar text-center mt-40">
                    ...
                    <div class="col-lg-12">
                        <div class="singel-patnar text-center mt-40">
                            <img src="images/Companies/QAU.png" alt="Logo">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="singel-patnar text-center mt-40">
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table class="table">
                          <caption>List of Startups (Still in Incubation)</caption>
                          <thead>
                            <tr class="gray-bg">
                              <th scope="col">#</th>
                              <th scope="col">Name of Startup/Company</th>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>Mr. Shah Ahad</td>
                              <td>+92 ##########</td>
                              <td>info@qau.edu.pk</td>
                            </tr>
                            <tr>
                              <th scope="row">2</th>
                              <td>Digital SMART Solutions</td>
                              <td> Mr. SubhanUllah</td>
                              <td>+92 ##########</td>
                              <td>info@qau.edu.pk</td>
                            </tr>
                          </tbody>
